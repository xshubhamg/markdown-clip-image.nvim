...
- [x] MIT LICENSE, README, vimdoc (`doc/markdown-clip-image.txt`)
- [x] `stylua.toml`, `.gitignore`, `:checkhealth`, headless tests, CI
- [ ] `git init && git add . && git commit && gh repo create your-username/markdown-clip-image.nvim --public --source=. --push`
- [ ] Tag `v1.0.0`, add repo topics: `neovim`, `markdown`, `clipboard`, `screenshot`, `wayland`
